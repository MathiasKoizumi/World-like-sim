...
namespace WindowsFormsApplication1
{
	public class Form1 : Form
	{
		...
		public void landingIsHere(int p)
		{
			...
			Thread.Sleep(400);
			ISoundEngine val = new ISoundEngine();
			val.Play2D("136702__hoscalegeek__laser-zap.wav");
		...
		public void flyBy()
		{
			...
			ISoundEngine val = new ISoundEngine();
			val.Play2D("157886__setuniman__funny-bassoon-0p-17bs4.wav");
			Bitmap bitmap = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height, PixelFormat.Format32bppArgb);
			using (Graphics graphics = Graphics.FromImage(bitmap))
			{
				graphics.CopyFromScreen(Screen.PrimaryScreen.Bounds.X, Screen.PrimaryScreen.Bounds.Y, 0, 0, Screen.PrimaryScreen.Bounds.Size, CopyPixelOperation.SourceCopy);
		...
		public void dropDownMyHoney()
		{
			...
			bootMeUp.set_SoundVolume(2f);
			ISoundEngine val = new ISoundEngine();
			val.Play2D("18870__zippi1__sound-alien7.wav", true);
			Bitmap bitmap = new Bitmap(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height, PixelFormat.Format32bppArgb);
			using (Graphics graphics = Graphics.FromImage(bitmap))
			{
				graphics.CopyFromScreen(Screen.PrimaryScreen.Bounds.X, Screen.PrimaryScreen.Bounds.Y, 0, 0, Screen.PrimaryScreen.Bounds.Size, CopyPixelOperation.SourceCopy);
		...
		public void violenceNearby()
		{
			...
			for (int l = 0; l < junkie.Next(50, 200); l++)
			{
				...
				case 0:
					...
					image = Image.FromStream(manifestResourceStream);
					val.Play2D("109753__soundcollectah__tre-hit-long.wav");
					break;
				case 1:
					...
					val.Play2D("35464__jobro__explosion-7.wav");
					image = Image.FromStream(manifestResourceStream);
					break;
				case 2:
					...
					image = Image.FromStream(manifestResourceStream);
					val.Play2D("86026__harpoyume__explosion-3.wav");
					break;
				case 3:
					...
					image = Image.FromStream(manifestResourceStream);
					val.Play2D("93846__cgeffex__huge-explosion6.wav");
					break;
				}
